...
순수한 템플릿을 준비했다면, 이제 FDE 엔진에서 인식할 수 있는 형식으로 tool call 기능을 추가해야 합니다. 가장 널리 사용되는 형식은 [Hermes Function Calling Standard](https://github.com/NousResearch/Hermes-Function-Calling) 형식입니다.
이 형식의 핵심 특징은 다음과 같습니다:
