...
[](https://cloud-images.ubuntu.com/minimal/releases/jammy/release/)からダウンロードできます。ubuntu-22.04-minimal-cloudimg-amd64.imgをダウンロードすればいいので、リンクをコピーしてwgetでダウンロードします。
