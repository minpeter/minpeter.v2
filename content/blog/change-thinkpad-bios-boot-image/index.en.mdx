...
What we'll change in this article is this screen: ![](./images/default-logo.jpg)
...
The pre-processed result is available at [/images/LOGO.GIF](./images/LOGO.GIF). ~~(The blog framework I switched to can't process GIFs.)~~

This character called Go Gopher is... licensed under CCA 3.0. CCA 3.0 allows commercial use with attribution, so you can download and use the above image. As an aside, the original creator [Renee French](http://reneefrench.blogspot.com/)... is creepy. Don't go there.
...
4. The computer will automatically reboot and wait for the downgrade to proceed. **Power connection is essential. Ensure stable power supply if you don't want to brick it.**
...
8. Put your prepared image in the `Rfs\StartupImages` folder. The filename must be one of **LOGO.GIF**, **LOGO.JPG**, or **LOGO.BMP**.

9. Find and run `WINUPTP.EXE`, and after waiting, the boot will proceed with the changed logo. It will persist even after the next BIOS update. Congratulations!! Now you have a cuter boot image :)
