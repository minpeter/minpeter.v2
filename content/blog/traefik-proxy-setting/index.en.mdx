...
For example, [ip.traefik.me](http://ip.traefik.me) also resolves to `127.0.0.1`. You can use this to send requests like the following:
...
Replace `minpeter.com` with your domain name in the configuration below.
