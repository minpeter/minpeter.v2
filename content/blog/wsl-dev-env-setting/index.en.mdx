...
A configuration wizard will appear - set up your preferred theme. If you want to reconfigure later, use the `p10k configure` command.

The author configured it as follows. ![](./images/cbec45ac-e3c6-4e00-8cd1-a5990b38682c-image.png)
...
![](./images/fb73e92a-040b-409b-b990-deb87e26686a-image.png) A useful option to remember is `--plain`. It changes to the following, making it easier to copy. ![](./images/d97ebd45-3cc8-4b1e-a91e-2c3f9e93bfae-image.png)
...
ls now has icons. You can see that the previously plain `ls` command now has icons. ![](./images/e5d83a96-c50c-4ad7-8691-8f312e2ea1e6-image.png)
...
asdf is a great tool for installing and managing versions of CLI tools like aws-cli, hugo, etc. Generally, tool installation follows these 4 steps as shown above:
