...
For someone like me who uses the zsh + oh-my-zsh combination, this was the worst. [![RVM zsh and oh-my-zsh compatibility warning](./assets/zsh+ohmyzsh-bug.png)](https://rvm.io/integration/zsh)
...
The theme I applied is called [chirpy](https://github.com/cotes2020/jekyll-theme-chirpy). It's well explained in the GitHub repo's README file, so I'll explain briefly.
