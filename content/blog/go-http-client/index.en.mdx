...
<aside>
  Before supporting the TRACE method server-side, learn about the role TRACE
  plays in XST (Cross-Site Tracking) attacks. In XST attacks, attackers use XSS
  to steal authenticated users' credentials.
</aside>
