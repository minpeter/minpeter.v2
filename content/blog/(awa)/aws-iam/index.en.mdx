...
This is the description on the AWS IAM dashboard. IAM stands for Identity and Access Management and uses a key-shaped logo. ![](./images/a4b4483d-f6e3-4cc0-8fa1-c78a8b440f49-image.png)
...
![](./images/8eab1eb3-bc5e-479b-92b6-6fed61a9d6ce-image.png) There are 2 types of IAM AWS credential types. Programmatic access using access keys, and AWS Management Console access using passwords. From now on, I'll call them key-based and password-based respectively.
