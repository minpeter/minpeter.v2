...
The redesign now carries into the link preview, too. Instead of reusing one static thumbnail, every post generates its own 1200×630 Open Graph image from the title and publication date. The cat mark, `MINPETER.COM`, fine grid, and monochrome palette carry the first screen of the site into every shared link.
