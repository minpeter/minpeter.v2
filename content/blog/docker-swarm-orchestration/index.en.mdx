...
[Deploying Docker Containers Using Swarm_1](https://cornswrold.tistory.com/512?category=930033) [Easy and Fast Distributed Server Management with Docker Swarm](https://subicura.com/2017/02/25/container-orchestration-with-docker-swarm.html) [docker docs](https://docs.docker.com/engine/swarm)
