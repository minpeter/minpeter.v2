...
When solving various CTF challenges and Dreamhack problems, you often encounter addresses like this: `nc pwnable.kr 9000` \*BOF challenge from pwnable.kr
...
That's what it says. You can think of it as an advanced version of netcat.

## Installing Socat

On Ubuntu, you can install it as follows: `apt-get install socat` On Mac, assuming brew is installed: `brew install socat`
