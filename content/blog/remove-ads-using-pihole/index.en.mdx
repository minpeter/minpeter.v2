...
So here's how to test it. It's [speedtest.net](https://www.speedtest.net/)!! This is an internet speed test site that has tons of ads if Pi-hole isn't working. But if Pi-hole is working properly, you shouldn't see any ads on that site. If you see ads, try the following 2 things.
...
[pi hole home page](https://pi-hole.net/) [Uprooting ads with Pi-Hole](https://kycfeel.github.io/2019/10/06/Pi-Hole%EB%A1%9C-%EA%B4%91%EA%B3%A0-%EB%BF%8C%EB%A6%AC%EB%BD%91%EA%B8%B0/) [pihole_test_site](https://www.reddit.com/r/pihole/comments/m1xran/pihole_test_site/)
